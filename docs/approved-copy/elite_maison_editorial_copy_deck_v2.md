...
1. Arabic and English are authored independently. Do not literal-translate one into the other.
2. Do not invent clients, dates, locations, awards, response times, team size, certifications, revenue, performance percentages, or capabilities not already supported by the repository.
3. The following factual claims remain locked:
   - More than 18 years of hands-on experience.
   - GCC market focus / experience.
   - Attractive Smile: 12 consecutive days of bookings; current approved non-quantified revenue growth / steadier demand wording only.
   - Bloom / Perfect Foodstuff: AED 18K in Q1 → AED 40K → average AED 65K/month.
   - Bin Ablan: Canada, Oman, Kuwait, Saudi Arabia, Libya; five-country market entry; new distribution channels.
   - Le Patchouli Café: 11 franchise branches; scalable/repeatable model.
   - AI Brains: clear/applicable/measurable project; “Award for Best AI-Supporting Project.” Do not add awarding body/year/rank.
4. SEO/GEO must be protected through page structure, metadata, semantic headings, answerability, internal linking and crawlable HTML — not by making every paragraph sound like a keyword target.
...
# 1. Global UI copy — REPLACE EXACTLY
...
| `exploreSectors` | استكشفوا خبرة القطاعات | Explore sector experience |
| `exploreCases` | شاهدوا ما تغيّر في العمل | See what changed in the work |
| `exploreInsights` | اقرأوا الرؤى | Read the insights |
| `engageCta` | اختاروا طريقة التعاون | Choose a way to work together |
| `viewCase` | اقرأوا الحالة | Read the case |
| `readInsight` | اقرأوا الرؤية | Read the insight |
| `footerContact` | ابدأوا حوارًا | Start a conversation |
| `notFound` | الصفحة التي تبحثون عنها غير موجودة. | The page you are looking for does not exist. |
...
- **Prioritize** — AR: نختار ما يستحق الآن، ونقبل بوضوح ما يجب أن ينتظر. / EN: Choose what deserves attention now, and be explicit about what should wait.
- **Execute** — AR: نحوّل القرار إلى عمل له مالك وإيقاع وطريقة متابعة. / EN: Turn the decision into work with ownership, rhythm and a way to follow it.
...
- **Challenge EN:** Opportunities are plentiful and resources are finite. The question is not where to find another growth idea, but which one deserves to move now.
- **Objective AR:** تحديد أين يمكن أن يأتي النمو، وترتيب الفرص بحسب ما يستحق التركيز.
- **Objective EN:** Identify where growth can come from and sequence the opportunities that deserve focus.
- **Scope AR:** الوضع الحالي، مصادر النمو، القيود، الأولويات، وما يجب أن ينتظر.
- **Scope EN:** The current position, sources of growth, constraints, priorities and what should wait.
- **Role AR:** تحويل طموح النمو إلى اختيارات واضحة يستطيع الفريق الدفاع عنها والعمل عليها.
- **Role EN:** Turn growth ambition into clear choices the team can defend and act on.
- **Measure AR:** أولويات محددة وخارطة تغيّر ما يفعله الفريق، لا وثيقة تُحفظ بعد العرض.
- **Measure EN:** Defined priorities and a roadmap that changes what the team does, not a document filed after the presentation.

## Capability 2 — Sales & Revenue Development
- **Challenge AR:** الاهتمام موجود، لكن شيئًا ما يضيع بين أول تفاعل والإيراد.
- **Challenge EN:** Interest exists, but something is being lost between first contact and revenue.
- **Objective AR:** تحديد أين يتسرب التحويل، وما الذي يمكن تغييره لاستعادة الزخم.
- **Objective EN:** Find where conversion is leaking and what can change to restore momentum.
- **Scope AR:** العرض، مراحل البيع، الانتقالات بين الفرق، نقاط الاحتكاك، وفرص الإيراد.
- **Scope EN:** The offer, sales stages, team handoffs, friction points and revenue opportunities.
- **Role AR:** ربط عمل المبيعات برحلة العميل وهدف النمو بدل قياس النشاط بمعزل عن النتيجة.
- **Role EN:** Connect sales activity to the customer journey and growth objective instead of measuring activity in isolation.
- **Measure AR:** مسار بيع أوضح، ونقاط تحويل ومتابعة يمكن للفريق العمل عليها.
- **Measure EN:** A clearer sales path with conversion and follow-up points the team can work on.

## Capability 3 — Market Expansion & Entry
- **Challenge AR:** السوق يبدو جذابًا. السؤال الحقيقي هو: هل أنتم جاهزون لدخوله بالطريقة الصحيحة؟
- **Challenge EN:** The market looks attractive. The real question is whether you are ready to enter it in the right way.
- **Objective AR:** اختبار الجاهزية ومنطق الدخول قبل أن تتحول الموارد إلى التزام يصعب التراجع عنه.
- **Objective EN:** Test readiness and the logic of entry before resources become a commitment that is difficult to reverse.
- **Scope AR:** اختيار السوق، الجاهزية، نموذج الدخول، القنوات، والقدرة على الخدمة والمتابعة.
- **Scope EN:** Market choice, readiness, entry model, channels and the ability to serve and follow the market.
- **Role AR:** تحويل التوسع من رغبة إلى قرار له معايير وطريقة دخول واضحة.
- **Role EN:** Turn expansion from an ambition into a decision with criteria and a clear route to entry.
- **Measure AR:** قرار أوضح حول الدخول وطريقته، مع شروط نجاح معروفة قبل الإطلاق.
- **Measure EN:** A clearer entry decision and route, with known conditions for success before launch.

## Capability 4 — Product & Business Model Development
- **Challenge AR:** القيمة موجودة، لكن العرض لا يقولها بوضوح — أو يصبح أصعب كلما حاولتم توسيعه.
- **Challenge EN:** The value exists, but the offer does not express it clearly — or becomes harder to run as you try to scale it.
- **Objective AR:** جعل القيمة المقدمة أوضح، والنموذج أنسب للمرحلة التالية.
- **Objective EN:** Make the value proposition clearer and the model better suited to the next stage.
- **Scope AR:** المنتج أو الخدمة، القيمة المقدمة، بنية العرض، ومنطق نموذج العمل.
- **Scope EN:** The product or service, value proposition, offer structure and business-model logic.
- **Role AR:** مواءمة ما تبيعه الشركة مع ما يستطيع السوق فهمه وتبنيه وما يستطيع العمل دعمه.
- **Role EN:** Align what the business sells with what the market can understand and adopt, and what the operation can support.
- **Measure AR:** عرض أوضح ونموذج أسهل في الفهم والتشغيل والتوسع.
- **Measure EN:** A clearer offer and a model that is easier to understand, operate and scale.

## Capability 5 — Franchise Systems Development
- **Challenge AR:** نجاح موقع واحد لا يضمن أن التجربة ستنجو من التكرار.
- **Challenge EN:** Success in one location does not guarantee the experience will survive repetition.
- **Objective AR:** تحويل النجاح المحلي إلى نموذج يمكن نقله من دون فقدان ما يجعل التجربة مميزة.
- **Objective EN:** Turn local success into a model that can travel without losing what makes the experience distinctive.
- **Scope AR:** معايير التشغيل، تجربة العميل، متطلبات العلامة، وما يجب أن يبقى ثابتًا عند التوسع.
- **Scope EN:** Operating standards, customer experience, brand requirements and what must remain consistent as the business expands.
- **Role AR:** تحديد ما يجب توحيده وما يمكن تكييفه حتى يصبح التوسع قابلًا للإدارة.
- **Role EN:** Define what must be standardized and what can adapt so expansion becomes manageable.
- **Measure AR:** نموذج تشغيل وتجربة يمكن تكرارهما بثبات أكبر.
- **Measure EN:** An operating model and customer experience that can be repeated more consistently.

## Capability 6 — Private Label Development
- **Challenge AR:** المنتج موجود. ما ينقصه هو منطق تجاري واضح يصل به إلى السوق ويمنحه طريقًا للنمو.
- **Challenge EN:** The product exists. What is missing is a clear commercial logic that gets it to market and gives it a path to grow.
- **Objective AR:** بناء منطق أوضح للعلامة وطريقها إلى السوق والتوزيع.
- **Objective EN:** Build a clearer commercial logic for the brand, its route to market and distribution.
- **Scope AR:** العرض، السوق، قنوات التوزيع، ومسار النمو.
- **Scope EN:** The offer, market, distribution channels and growth path.
- **Role AR:** ربط المنتج بسوق وقناة وسياق تجاري يستطيع العمل دعمه.
- **Role EN:** Connect the product to a market, channel and commercial context the business can support.
- **Measure AR:** طريق سوق وتوزيع واضح يمكن البناء عليه.
- **Measure EN:** A defined market and distribution path the business can build on.

## Capability 7 — Customer Journey & Experience
- **Challenge AR:** العميل يريد التقدم، لكن الرحلة تجعله يعمل أكثر مما ينبغي.
- **Challenge EN:** The customer wants to move forward, but the journey makes them work harder than they should.
- **Objective AR:** تقليل الاحتكاك وتحسين اللحظات التي تؤثر في التحويل والعودة والولاء.
- **Objective EN:** Reduce friction and improve the moments that influence conversion, return and loyalty.
- **Scope AR:** نقاط التفاعل، الانتقالات بين الفرق، الخطوة التالية، ومسار العميل من الاهتمام إلى ما بعد الشراء.
- **Scope EN:** Touchpoints, team handoffs, the next step and the customer path from interest through post-purchase.
- **Role AR:** جعل تجربة العميل جزءًا من الأداء التجاري، لا طبقة تجميل منفصلة عنه.
- **Role EN:** Make customer experience part of commercial performance, not a cosmetic layer beside it.
- **Measure AR:** رحلة أبسط ونقاط احتكاك محددة يمكن تحسينها ومتابعتها.
- **Measure EN:** A simpler journey with defined friction points that can be improved and followed.

## Capability 8 — Executive Growth Management
- **Challenge AR:** الفرق تتحرك، لكن لا أحد يرى الصورة كلها أو يملك إيقاع المتابعة عبر المبادرات.
- **Challenge EN:** Teams are moving, but no one sees the whole picture or owns the rhythm across initiatives.
- **Objective AR:** توحيد الأولويات والمتابعة حول هدف تجاري مشترك.
- **Objective EN:** Align priorities and follow-up around a shared commercial objective.
- **Scope AR:** إدارة المبادرات، التنسيق بين الفرق، مؤشرات الأداء، وإيقاع المراجعة.
- **Scope EN:** Initiative management, cross-team coordination, performance indicators and review rhythm.
- **Role AR:** إبقاء القرار والتنفيذ في المسار نفسه حتى لا تتوزع الأولويات بين الفرق.
- **Role EN:** Keep decisions and execution on the same path so priorities do not fragment across teams.
- **Measure AR:** أولويات ومؤشرات ومسؤوليات تنفيذ يمكن تتبعها بوضوح.
- **Measure EN:** Priorities, indicators and execution ownership that can be clearly tracked.
...
- **Objective EN:** Turn spend into demand that can be tracked and improved, not activity metrics detached from the outcome.
- **Scope AR:** تخطيط وإدارة الحملات المدفوعة ومسارات التحويل ومتابعة الأداء.
- **Scope EN:** Plan and manage paid campaigns, conversion paths and performance follow-up.
- **Impact AR:** قرارات إنفاق تتغير بناءً على ما يقترب من النتيجة التجارية، لا على المؤشرات السطحية وحدها.
- **Impact EN:** Spending decisions shaped by what moves closer to the commercial outcome, not surface metrics alone.
- **Metrics:** Keep current approved acquisition / conversion / return-on-spend wording.

## Campaign & Digital Channel Management
- **Objective AR:** جعل الرسالة والعرض والخطوة التالية متصلة عبر القنوات.
- **Objective EN:** Make the message, offer and next step connected across channels.
- **Scope AR:** تخطيط الحملات، تشغيل القنوات، ومتابعة الأداء عبر المسار.
- **Scope EN:** Campaign planning, channel execution and performance follow-up across the path.
- **Impact AR:** تجربة أقل تجزؤًا من أول تفاعل حتى الخطوة التالية.
- **Impact EN:** A less fragmented experience from first interaction to the next action.
- **Metrics:** Keep current approved channel / conversion-path / agreed-indicator wording.

## Business Systems & Marketing Operations
- **Objective AR:** إخراج المتابعة من العمل اليدوي والمعلومات المتفرقة إلى نظام يرى الفريق من خلاله ما يحدث.
- **Objective EN:** Move follow-up out of manual work and scattered information into a system the team can use to see what is happening.
- **Scope:** Keep current CRM / dashboards / workflow tools wording.
- **Impact AR:** رؤية أوضح، ومسؤولية أسهل في التتبع، وقرارات أقل اعتمادًا على البحث عن المعلومة.
- **Impact EN:** Clearer visibility, ownership that is easier to follow and decisions less dependent on hunting for information.
- **Metrics:** Keep current system-use / follow-up-completeness / core-indicator wording.

## Automation & AI Solutions
- **Objective AR:** إزالة العمل المتكرر حين تستطيع الأتمتة أو الذكاء الاصطناعي أداءه بصورة أنسب.
- **Objective EN:** Remove repetitive work where automation or AI can handle it more appropriately.
- **Scope AR:** أتمتة عمليات محددة وتوظيف الذكاء الاصطناعي داخل مسارات عمل واضحة لها نتيجة معروفة.
- **Scope EN:** Automate defined processes and apply AI inside clear workflows with a known intended outcome.
- **Impact AR:** تقنية تختفي داخل طريقة العمل بدل أن تصبح طبقة جديدة من التعقيد.
- **Impact EN:** Technology that disappears into the way of working instead of becoming another layer of complexity.
- **Metrics:** Keep current workflow-efficiency / follow-up-quality wording.

## Branding & Creative Identity
- **Objective AR:** منح العلامة لغة وصورة تعكسان المكان الذي تريد أن تحتله في ذهن السوق.
- **Objective EN:** Give the brand a language and identity that reflect the position it intends to own in the market.
- **Scope:** Keep current identity / messaging / creative-system wording.
- **Impact AR:** حضور أكثر اتساقًا وتميزًا ووضوحًا عبر نقاط التواصل.
- **Impact EN:** A more consistent, distinctive and recognizable presence across touchpoints.
- **Metrics:** Keep current consistency-of-identity-and-messaging wording.

## Marketing Activation & Performance Optimization
- **Objective AR:** منع الخطة من أن تنتهي عند الإطلاق: تشغيل، قياس، تعديل، ثم تحسين مستمر.
- **Objective EN:** Keep the plan from ending at launch: run, measure, adjust and keep improving.
- **Scope:** Keep current campaigns / channels / follow-up / continuous-improvement wording.
- **Impact AR:** تنفيذ يبقى حيًا بعد الإطلاق ويتغير مع ما تظهره النتائج.
- **Impact EN:** Execution that stays alive after launch and evolves with what the results reveal.
- **Metrics:** Keep current improvement-over-time wording.
...
- **Context EN:** A product does not grow because it is known alone; it grows when it is available, understood and chosen again. Distribution, price, clarity of choice and repeat purchase belong to the same picture.
- **Challenges:** Keep current approved wording.
- **Priorities AR:** قناة مناسبة، تغطية يمكن توسيعها، وعرض تستطيع العلامة دعمه باستمرار.
- **Priorities EN:** The right channel, coverage that can scale and an offer the brand can support consistently.
- **Journey:** Keep current approved wording.

## Food & Beverage / Hospitality
- **Context AR:** في الضيافة، العلامة تُعاش أكثر مما تُرى. التجربة داخل المكان، التشغيل، الخدمة، والقدرة على تكرار المستوى نفسه هي ما يحمل الهوية إلى التوسع.
- **Context EN:** In hospitality, the brand is experienced more than it is seen. On-site experience, operations, service and the ability to repeat the same standard are what carry identity into expansion.
- **Challenges:** Keep current approved wording.
- **Priorities:** Keep current approved wording.
- **Journey:** Keep current approved wording.

## Retail & Distribution
- **Context AR:** في التجزئة والتوزيع، الطريق إلى السوق جزء من النمو نفسه. أين يوجد المنتج، كيف يصل، ومن يملك علاقة القناة قد يحدد النتيجة بقدر الطلب.
- **Context EN:** In retail and distribution, the route to market is part of growth itself. Where the product is available, how it gets there and who owns the channel relationship can shape the outcome as much as demand.
- **Challenges:** Keep current approved wording.
- **Priorities:** Keep current approved wording.
- **Journey:** Keep current approved wording.

## E-commerce
- **Context AR:** في التجارة الإلكترونية، كل خطوة بين الإعلان والدفع يمكن أن تضيف قيمة أو تسرّبها. لذلك يجب أن تُقرأ القناة وتجربة الشراء والعودة والقياس كنظام واحد.
- **Context EN:** In e-commerce, every step between the ad and payment can add value or leak it. Channel, purchase experience, return behaviour and measurement need to be read as one system.
- **Challenges / Priorities / Journey:** Keep current approved wording.

## Education & Training
- **Context AR:** العميل لا يشتري برنامجًا فقط؛ يراهن على نتيجة مستقبلية. لذلك يصبح وضوح البرنامج والقيمة ومسار التسجيل جزءًا أساسيًا من القرار.
...
- **Challenge EN:** The medical centre was entering an expansion phase. The question was not how to add more marketing activity, but how to support expansion with steadier demand and bookings.
- **Strategy AR:** ربط هدف التوسع بمسار الطلب، والتركيز على ما يساعد الاهتمام على التحول إلى حجوزات بصورة أكثر انتظامًا.
- **Strategy EN:** Connect the expansion objective to the demand path and focus on what could turn interest into bookings more consistently.
- **Execution:** Keep current approved wording.
- **Result:** Keep current approved result wording exactly.
- **Proof:** Keep `12 consecutive days of bookings` exactly.

## Bloom / Perfect Foodstuff
- **Challenge AR:** المنتج والسوق كانا موجودين؛ ما لم يكن يلتقط الإمكانات التجارية المتاحة بالقدر الكافي هو نموذج النمو وقنوات البيع.
- **Challenge EN:** The product and market were already there; the growth model and sales channels were not capturing the available commercial potential strongly enough.
- **Strategy AR:** إعادة تصميم منطق النمو حول فرص إيراد أوضح بدل التعامل مع المبيعات كمسار ثابت لا يتغير.
- **Strategy EN:** Redesign the growth logic around clearer revenue opportunities rather than treating sales as a fixed path.
- **Execution AR:** إعادة تصميم قنوات البيع لتخدم النموذج الجديد وتمنح العمل طريقًا تجاريًا أوضح.
- **Execution EN:** Redesign sales channels to support the new model and give the business a clearer commercial path.
- **Result / Proof / Metric:** Keep every approved AED figure exactly. Do not infer percentages.

## Bin Ablan
- **Challenge AR:** كان النمو يتطلب أسواقًا وقنوات توزيع جديدة. قبل توسيع النشاط، كان لا بد من حسم أين وكيف يحدث التوسع.
- **Challenge EN:** Growth required new markets and distribution channels. Before expanding activity, the business needed a clearer decision on where and how expansion should happen.
- **Strategy / Execution:** Keep current approved wording.
- **Result / Proof / Markets:** Keep Canada, Oman, Kuwait, Saudi Arabia and Libya exactly. Keep five-country market entry wording. Add no dates or revenue.

## Le Patchouli Café
- **Challenge AR:** نجاح العلامة في موقعها لم يكن السؤال الأصعب. السؤال كان كيف يصبح هذا النجاح نموذجًا يمكن تكراره عند التوسع.
- **Challenge EN:** Success at the location level was not the hardest question. The harder question was how that success could become a model that could be repeated as the brand expanded.
- **Strategy / Execution:** Keep current approved wording.
- **Result / Proof:** Keep `11 franchise branches` and approved scalability wording exactly.

## AI Brains — AI Solutions
- **Challenge AR:** الفكرة كانت موجودة. ما احتاج إلى الوضوح هو أين تكمن قيمتها، وكيف تتحول من مفهوم واسع إلى مشروع يمكن تطبيقه وقياسه.
- **Challenge EN:** The idea already existed. What needed clarity was where its value sat and how to turn a broad concept into a project that could be applied and measured.
- **Strategy AR:** صياغة المشروع حول قيمة واضحة وحالة استخدام قابلة للتحويل إلى عمل، بدل إبقاء الذكاء الاصطناعي كعنوان عام.
- **Strategy EN:** Shape the project around clear value and a use case that could be turned into work, rather than leaving AI as a broad label.
- **Execution / Result:** Keep current approved wording.
- **Proof AR:** جائزة أفضل مشروع داعم للذكاء الاصطناعي.
- **Proof EN:** Award for Best AI-Supporting Project.
